package md.varoinform.cypher;


import md.varoinform.cypher.util.StringConverter;
import org.apache.commons.lang3.ArrayUtils;
import java.io.UnsupportedEncodingException;
import java.lang.Exception;import java.lang.String;import java.security.MessageDigest;
...
public class Cypher {
    ...
    public byte[] encrypt(String data, byte[] key) throws CryptographyException {
        try {
            ...
            // ArrayUtils.addAll(Object[] array1, Object[] array2)
            // takes only two arguments and returns new array contains all of the element of array1 followed by all of the elements array2.
